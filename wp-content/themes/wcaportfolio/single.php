...
<div class="single">
  ...
  <div class="section">
    ...
    <div class="section__tags">
      ...
      <a href="#" class="section__tags__works">Designing Dashboards</a>
    </div>

    <h1 class="section__title">Designing Dashboards with usability in mind</h1>

    <div class="section__info">
      <div class="section__info__yearpill">2020</div>
      <div class="section__info__category">Dashboard, User Experience Design</div>
    </div>
    ...
    <div class="section__dashboardImg"><img src=" https://wcaportfolio.local/wp-content/themes/wcaportfolio/assets/single/dashboard1.png" alt="" srcset="">
    </div>


    <h2 class="section__h2">Heading 2</h2>
    <h3 class="section__h3">Heading 3</h3>
    ...
    <div class="section__carImg"><img src="https://wcaportfolio.local/wp-content/themes/wcaportfolio/assets/single/dashboard2.png" alt="" srcset="">
    </div>

    <div class="section__checkImg"><img src="https://wcaportfolio.local/wp-content/themes/wcaportfolio/assets/single/dashboard3.png" alt="" srcset="">
    </div>
  </div>
</div>
